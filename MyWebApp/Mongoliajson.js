...
$('#Species').multiselect({
  placeholder: 'Select Mammal Species',
  search: true,
  selectAll: true,
  selectGroup: true,
...
$('#Ectoparasites').multiselect({
  placeholder: 'Select Ectoparasite Species',
  search: true,
  selectAll: true,
  selectGroup: true,
  maxPlaceholderOpts: 1,
...
$('#Endoparasites').multiselect({
  placeholder: 'Select Endoparasite Species',
  search: true,
  selectAll: true,
  selectGroup: true,
  maxPlaceholderOpts: 1,
  ...
  L.geoJSON(filteredFeatures, {
    onEachFeature: function (feature, layer) {
        ...
        var popupContent = "<strong>Scientific Name: </strong>" + feature.properties.scientific_name + "<br>" +
            ...
            "<strong>Coordinates: </strong>" + feature.geometry.coordinates + "<br>" +
            "<strong>Ectoparasites Detected: </strong>" + feature.properties.ParaEcto + "<br>" +
            "<strong>Total Ectoparasites Detected: </strong>" + feature.properties.total_ecto + "<br>" +
            "<strong>Endoparasites Detected: </strong>" + feature.properties.ParaEndo + "<br>" +
            "<strong> Total Endoparasites Detected: </strong>" + feature.properties.total_endo + "<br>" +
            "<strong>Catalog Number: </strong><a href='https://arctos.database.museum/guid/" + MSB_mammal_number + "' target='_blank'>" + MSB_mammal_number + "</a>";
...
$('#range').multiselect({
  placeholder: 'Select Mammal Species Range',
  search: true,
  selectAll: true,
  selectGroup: true,
  maxPlaceholderOpts: 1,
